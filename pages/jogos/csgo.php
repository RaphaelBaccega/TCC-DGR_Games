...
<body>
  ...
  <div class="container">
    <div class="text-center text-white">
      <h1>Counter Strike: Global Offensive by Valve</h1>
    </div>
    <div class="row">
      ...
      <div class="col-lg-4 col-md-12 col-sm-6">
        <div class="card">
          <div class="card-body text-center">
            <div>
              <img src="https://s1.gaming-cdn.com/images/products/9459/orig-fallback-v1/counter-strike-global-offensive-pc-mac-jogo-steam-cover.jpg" width="100%" 
              height="216" class="rounded" alt="" />
              ...
              <div class="d-grid">
                <a href="https://store.steampowered.com/app/730/CounterStrike_Global_Offensive/" target="_blank" class="btn btn-primary radius-15">COMPRAR</a>
              </div>
            </div>
          </div>
        </div>
