...
<body>
    ...
    <div class="container">
        <div class="text-center text-white">
            <h1>Quantum Break by Remedy Entertainment</h1>
        </div>
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-sm-6">
                <div class="card">
                    <div class="card-body text-center">
                        <div>
                            <img src="https://images-americanas.b2w.io/produtos/01/00/img/33456/5/33456531_1GG.jpg" width="100%" class="rounded" alt="" />
                            <h5 class="mb-0 mt-4">Standart Edition</h5>
                            <div class="list-inline contacts-social mt-3 mb-3">
                                <img src="../../assets/imgs/icons/xbox-logo.png" alt="" />
                            </div>
                            <p class="text-start text-bold">R$69,95</p>
                            <div class="d-grid">
                                <a href="https://www.xbox.com/pt-BR/games/store/quantum-break/9nblggh6h0rv" target="_blank" class="btn btn-primary radius-15">COMPRAR</a>
                            </div>
                        </div>
                    </div>
                </div>
