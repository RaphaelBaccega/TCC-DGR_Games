...
<body>
  ...
  <div class="container">
    <div class="text-center text-white">
      <h1>RAFT by Redbeet Interactive</h1>
    </div>
    <div class="row">
      ...
      <div class="col-lg-4 col-md-12 col-sm-6">
        <div class="card">
          <div class="card-body text-center">
            <div>
              <img src="https://styles.redditmedia.com/t5_369sb/styles/communityIcon_2psdsp7he1741.png" width="100%" height="220px" class="rounded" alt="" />
              <h5 class="mb-0 mt-4">Standart Edition</h5>
              <div class="list-inline contacts-social mt-3 mb-3">
                <img src="../../assets/imgs/icons/pc-logo.png" alt="" />
              </div>
              <p class="text-start text-bold">R$36,99</p>
              <div class="d-grid">
                <a href="https://store.steampowered.com/app/648800/Raft/" target="_blank" class="btn btn-primary radius-15">COMPRAR</a>
              </div>
            </div>
          </div>
        </div>
