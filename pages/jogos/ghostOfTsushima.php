...
<body>
  ...
  <div class="container">
    <div class="text-center text-white">
      <h1>Ghost of Tsushima by Sony Interactive Entertainment</h1>
    </div>
    <div class="row">
      <div class="col-lg-4 col-md-6">
        <div class="card">
          <div class="card-body text-center">
            <div>
              <img src="https://image.api.playstation.com/vulcan/img/rnd/202108/2719/LnjXN1f1qsOLAn9tiPfAiRuq.png" width="100%" class="rounded" alt="" />
              <h5 class="mb-0 mt-4">Legends Edition</h5>
              <div class="list-inline contacts-social mt-3 mb-3">
                <img src="../../assets/imgs/icons/playstation-logo.png" alt="" />
              </div>
              <p class="text-start">R$104,90</p>
              <div class="d-grid">
                <a href="https://store.playstation.com/pt-br/product/UP9000-CUSA11456_00-GHOSTSHIP0000001/" target="_blank" class="btn btn-primary">COMPRAR</a>
              </div>
            </div>
          </div>
        </div>
